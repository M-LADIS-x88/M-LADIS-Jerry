...
: ${AMENT_CURRENT_PREFIX:="/home/robmoemac/M-LADIS-Jerry/ws_sensor_combined/install/apriltag_ros"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/apriltag_ros/environment/pythonpath.sh"
