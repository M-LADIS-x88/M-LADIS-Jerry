...
class Metaclass_Reset(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from lidar_slam.srv import _reset
...
class Reset(metaclass=Metaclass_Reset):
    from lidar_slam.srv._reset import Reset_Request as Request
    from lidar_slam.srv._reset import Reset_Response as Response
