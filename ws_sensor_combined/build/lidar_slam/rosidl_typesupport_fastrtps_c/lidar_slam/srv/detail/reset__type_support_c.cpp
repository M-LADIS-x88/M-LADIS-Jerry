...
#include "lidar_slam/srv/detail/reset__rosidl_typesupport_fastrtps_c.h"
...
using _Reset_Request__ros_msg_type = lidar_slam__srv__Reset_Request;
...
size_t get_serialized_size_lidar_slam__srv__Reset_Request(
  const void * untyped_ros_message,
...
static uint32_t _Reset_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_lidar_slam__srv__Reset_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_lidar_slam
size_t max_serialized_size_lidar_slam__srv__Reset_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lidar_slam__srv__Reset_Request;
    is_plain =
      (
...
static size_t _Reset_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_lidar_slam__srv__Reset_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lidar_slam, srv, Reset_Request)() {
...
using _Reset_Response__ros_msg_type = lidar_slam__srv__Reset_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_lidar_slam
size_t get_serialized_size_lidar_slam__srv__Reset_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Reset_Response__ros_msg_type * ros_message = static_cast<const _Reset_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_lidar_slam__srv__Reset_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_lidar_slam
size_t max_serialized_size_lidar_slam__srv__Reset_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = lidar_slam__srv__Reset_Response;
    is_plain =
      (
...
static size_t _Reset_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_lidar_slam__srv__Reset_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lidar_slam, srv, Reset_Response)() {
...
// already included above
// #include "lidar_slam/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "lidar_slam/srv/reset.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lidar_slam, srv, Reset)() {
