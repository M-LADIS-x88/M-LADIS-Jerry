...
{
  new (message_memory) lidar_slam::srv::Reset_Request(_init);
}

void Reset_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<lidar_slam::srv::Reset_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Reset_Request_message_member_array[1] = {
  {
    ...
    offsetof(lidar_slam::srv::Reset_Request, structure_needs_at_least_one_member),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Reset_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(lidar_slam::srv::Reset_Request),
...
get_message_type_support_handle<lidar_slam::srv::Reset_Request>()
{
  return &::lidar_slam::srv::rosidl_typesupport_introspection_cpp::Reset_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lidar_slam, srv, Reset_Request)() {
  return &::lidar_slam::srv::rosidl_typesupport_introspection_cpp::Reset_Request_message_type_support_handle;
}
...
void Reset_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) lidar_slam::srv::Reset_Response(_init);
}

void Reset_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<lidar_slam::srv::Reset_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Reset_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(lidar_slam::srv::Reset_Response, success),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Reset_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(lidar_slam::srv::Reset_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<lidar_slam::srv::Reset_Response>()
{
  return &::lidar_slam::srv::rosidl_typesupport_introspection_cpp::Reset_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lidar_slam, srv, Reset_Response)() {
  return &::lidar_slam::srv::rosidl_typesupport_introspection_cpp::Reset_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers Reset_service_members = {
  ...
  // see get_service_type_support_handle<lidar_slam::srv::Reset>()
...
get_service_type_support_handle<lidar_slam::srv::Reset>()
{
  // get a handle to the value to be returned
  auto service_type_support =
    &::lidar_slam::srv::rosidl_typesupport_introspection_cpp::Reset_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lidar_slam, srv, Reset)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<lidar_slam::srv::Reset>();
}
