...
#include "lidar_slam/srv/detail/reset__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lidar_slam::srv::Reset_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const lidar_slam::srv::Reset_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lidar_slam::srv::Reset_Request *>(
    untyped_ros_message);
...
{
  return &lidar_slam::srv::typesupport_fastrtps_cpp::_Reset_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = lidar_slam::srv::Reset_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const lidar_slam::srv::Reset_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<lidar_slam::srv::Reset_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &lidar_slam::srv::typesupport_fastrtps_cpp::_Reset_Response__handle;
}
...
{
  return &lidar_slam::srv::typesupport_fastrtps_cpp::_Reset__handle;
}
