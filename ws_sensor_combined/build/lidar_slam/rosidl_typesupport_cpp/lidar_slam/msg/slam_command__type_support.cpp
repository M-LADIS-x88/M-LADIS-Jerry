...
static const _SlamCommand_type_support_symbol_names_t _SlamCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lidar_slam, msg, SlamCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lidar_slam, msg, SlamCommand)),
  }
};
...
{
  return &::lidar_slam::msg::rosidl_typesupport_cpp::SlamCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, lidar_slam, msg, SlamCommand)() {
  return get_message_type_support_handle<lidar_slam::msg::SlamCommand>();
}
