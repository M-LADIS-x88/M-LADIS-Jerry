...
static const _SavePc_Request_type_support_symbol_names_t _SavePc_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lidar_slam, srv, SavePc_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lidar_slam, srv, SavePc_Request)),
  }
};
...
{
  return &::lidar_slam::srv::rosidl_typesupport_cpp::SavePc_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, lidar_slam, srv, SavePc_Request)() {
  return get_message_type_support_handle<lidar_slam::srv::SavePc_Request>();
}
...
static const _SavePc_Response_type_support_symbol_names_t _SavePc_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lidar_slam, srv, SavePc_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lidar_slam, srv, SavePc_Response)),
  }
};
...
{
  return &::lidar_slam::srv::rosidl_typesupport_cpp::SavePc_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, lidar_slam, srv, SavePc_Response)() {
  return get_message_type_support_handle<lidar_slam::srv::SavePc_Response>();
}
...
static const _SavePc_type_support_symbol_names_t _SavePc_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lidar_slam, srv, SavePc)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lidar_slam, srv, SavePc)),
  }
};
...
{
  return &::lidar_slam::srv::rosidl_typesupport_cpp::SavePc_service_type_support_handle;
}
