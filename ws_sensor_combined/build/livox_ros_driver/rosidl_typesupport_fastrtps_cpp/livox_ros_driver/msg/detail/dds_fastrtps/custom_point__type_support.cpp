...
#include "livox_ros_driver/msg/detail/custom_point__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const livox_ros_driver::msg::CustomPoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  livox_ros_driver::msg::CustomPoint & ros_message)
{
  // Member: offset_time
  cdr >> ros_message.offset_time;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = livox_ros_driver::msg::CustomPoint;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const livox_ros_driver::msg::CustomPoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<livox_ros_driver::msg::CustomPoint *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_livox_ros_driver
const rosidl_message_type_support_t *
get_message_type_support_handle<livox_ros_driver::msg::CustomPoint>()
{
  return &livox_ros_driver::msg::typesupport_fastrtps_cpp::_CustomPoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, livox_ros_driver, msg, CustomPoint)() {
  return &livox_ros_driver::msg::typesupport_fastrtps_cpp::_CustomPoint__handle;
}
