...
#include "livox_ros_driver/msg/detail/custom_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const livox_ros_driver::msg::CustomPoint &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: points
  {
    ...
    for (size_t i = 0; i < size; i++) {
      livox_ros_driver::msg::typesupport_fastrtps_cpp::cdr_serialize(
  ...
  livox_ros_driver::msg::CustomMsg & ros_message)
{
  ...
  // Member: points
  {
    ...
    for (size_t i = 0; i < size; i++) {
      livox_ros_driver::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        livox_ros_driver::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        livox_ros_driver::msg::typesupport_fastrtps_cpp::max_serialized_size_CustomPoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = livox_ros_driver::msg::CustomMsg;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const livox_ros_driver::msg::CustomMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<livox_ros_driver::msg::CustomMsg *>(
    untyped_ros_message);
...
{
  return &livox_ros_driver::msg::typesupport_fastrtps_cpp::_CustomMsg__handle;
}
