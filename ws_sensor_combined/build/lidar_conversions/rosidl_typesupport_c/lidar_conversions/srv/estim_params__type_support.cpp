...
static const _EstimParams_Request_type_support_symbol_names_t _EstimParams_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lidar_conversions, srv, EstimParams_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lidar_conversions, srv, EstimParams_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, lidar_conversions, srv, EstimParams_Request)() {
  return &::lidar_conversions::srv::rosidl_typesupport_c::EstimParams_Request_message_type_support_handle;
}
...
static const _EstimParams_Response_type_support_symbol_names_t _EstimParams_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lidar_conversions, srv, EstimParams_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lidar_conversions, srv, EstimParams_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, lidar_conversions, srv, EstimParams_Response)() {
  return &::lidar_conversions::srv::rosidl_typesupport_c::EstimParams_Response_message_type_support_handle;
}
...
static const _EstimParams_type_support_symbol_names_t _EstimParams_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lidar_conversions, srv, EstimParams)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lidar_conversions, srv, EstimParams)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, lidar_conversions, srv, EstimParams)() {
  return &::lidar_conversions::srv::rosidl_typesupport_c::EstimParams_service_type_support_handle;
}
